...
window.addEventListener('message', e => {
  console.log("listen for done message")
...
exports.delete = itemIndex => {
  console.log("time to delete at: " + itemIndex);
...
exports.getSelectedItem = () => {
  ...
  // console.log(child);
  while(
    (child = child.previousSibling) != null ) {
    console.log("in while");
    console.log(child);
    console.log(itemIndex);
    itemIndex++;
    console.log("indexVal in while: " + itemIndex);
  }
  console.log("final index val: " + itemIndex)
...
exports.addItem = (item, isNew = false)=> {
  ...
  console.log("ay from the REAL additem");
  ...
  // if this is the firs item, select it.
